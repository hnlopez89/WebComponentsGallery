...
import {TOGGLE_ON_LABEL_VARIANT} from "../constants.js"
import {DARK_OPTION,
        LIGHT_OPTION,
        LABEL_ON_OPTION,
        CLICK_TOGGLE,
...
Style1[LABEL_OFF_CONTAINER][CLICK_TOGGLE]= {
    color: TYPOGRAPHY_02,
}
...
Style1[LABEL_ON_CONTAINER][CLICK_TOGGLE]= {
...
Style1Path[LABEL_ATTRIBUTE] = LABEL_ON_OPTION
Style1Path[WIDTH_ATTRIBUTE] = FIT_CONTENT_OPTION

const styleWrapper1 = {}
styleWrapper1[STYLE_OBJECT] = {...Style1}
styleWrapper1[COMPONENT_VARIANT_KEY] = TOGGLE_ON_LABEL_VARIANT
styleWrapper1[PATH_STYLE] = Style1Path


toggleOnStyles.push(styleWrapper1)

const Style2 = JSON.parse(JSON.stringify(Style1))
Style2[LABEL_OFF_CONTAINER].color = TYPOGRAPHY_03
Style2[LABEL_OFF_CONTAINER].transition= "0.1s all ease-in-out",
Style2[LABEL_OFF_CONTAINER][CLICK_TOGGLE].color=TYPOGRAPHY_04
Style2[LABEL_ON_CONTAINER].transition= "0.1s all ease-in-out",
Style2[LABEL_ON_CONTAINER].color = TYPOGRAPHY_04
Style2[LABEL_ON_CONTAINER][CLICK_TOGGLE].color=TYPOGRAPHY_03
...
Style2Path[LABEL_ATTRIBUTE] = LABEL_ON_OPTION
Style2Path[WIDTH_ATTRIBUTE] = FIT_CONTENT_OPTION

const styleWrapper2 = {}
styleWrapper2[STYLE_OBJECT] = {...Style2}
styleWrapper2[COMPONENT_VARIANT_KEY] = TOGGLE_ON_LABEL_VARIANT
styleWrapper2[PATH_STYLE] = Style2Path

toggleOnStyles.push(styleWrapper2)

const Style3 = JSON.parse(JSON.stringify(Style1))
Style3[WRAPPER_CONTAINER].width = "100%"
...
Style3Path[LABEL_ATTRIBUTE] = LABEL_ON_OPTION
Style3Path[WIDTH_ATTRIBUTE] = FULL_OPTION

const styleWrapper3 = {}
styleWrapper3[STYLE_OBJECT] = {...Style3}
styleWrapper3[COMPONENT_VARIANT_KEY] = TOGGLE_ON_LABEL_VARIANT
styleWrapper3[PATH_STYLE] = Style3Path

toggleOnStyles.push(styleWrapper3)

const Style4 = JSON.parse(JSON.stringify(Style3))
Style4[LABEL_OFF_CONTAINER].color = TYPOGRAPHY_03
Style4[LABEL_OFF_CONTAINER].transition= "0.1s all ease-in-out",
Style4[LABEL_OFF_CONTAINER][CLICK_TOGGLE].color=TYPOGRAPHY_04
Style4[LABEL_ON_CONTAINER].transition= "0.1s all ease-in-out",
Style4[LABEL_ON_CONTAINER].color = TYPOGRAPHY_04
Style4[LABEL_ON_CONTAINER][CLICK_TOGGLE].color=TYPOGRAPHY_03
...
Style4Path[LABEL_ATTRIBUTE] = LABEL_ON_OPTION
Style4Path[WIDTH_ATTRIBUTE] = FULL_OPTION

const styleWrapper4 = {}
styleWrapper4[STYLE_OBJECT] = {...Style4}
styleWrapper4[COMPONENT_VARIANT_KEY] = TOGGLE_ON_LABEL_VARIANT
styleWrapper4[PATH_STYLE] = Style4Path

toggleOnStyles.push(styleWrapper4)
export  {toggleOnStyles};