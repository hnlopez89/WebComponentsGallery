...
import {LOGOUT_OPTION, LOG_IN_OPTION} from "../constants.js"
import {SHOW_TITLE_OPTION, SHOW_BADGE_OPTION } from "../constants.js"
import {LOG_IN_INITIALS_BADGE_PROFILE_VARIANT} from "../constants.js"
import {CONTAINER_SLOT_WRAPPER,
        ...
        BADGE_SUBCOMPONENT} from "../constants.js"
import { WARNING_EVENT, ERROR_EVENT, DEFAULT_EVENT, SUCCESS_EVENT } from "../constants.js"
import { BRAND_ATLANTIC_10, TYPOGRAPHY_03,
        TYPOGRAPHY_01, ALERT_SUCCESS, ALERT_WARNING,
...
const profileInitialsBadgeStyles = []
const Style1 = {}
...
Style1[PROFILE_CONTAINER_SUBCOMPONENT] = {
    backgroundColor: BRAND_ATLANTIC_10,
    position: "absolute",
    width: "64px",
    height: "64px",
...
Style1Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style1Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const style1Wrapper = {}
style1Wrapper[STYLE_OBJECT] = {...Style1}
style1Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
style1Wrapper[PATH_STYLE] = Style1Path
profileInitialsBadgeStyles.push(style1Wrapper)
...
Style2[PROFILE_CONTAINER_SUBCOMPONENT].width = "56px"
Style2[PROFILE_CONTAINER_SUBCOMPONENT].height = "56px"
...
Style2Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style2Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style2Wrapper = {}
Style2Wrapper[STYLE_OBJECT] = {...Style2}
Style2Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style2Wrapper[PATH_STYLE] = Style2Path
profileInitialsBadgeStyles.push(Style2Wrapper)
...
Style3[PROFILE_CONTAINER_SUBCOMPONENT].width = "48px"
Style3[PROFILE_CONTAINER_SUBCOMPONENT].height = "48px"
const Style3Path = {}
Style3Path[SIZE_ATTRIBUTE] = LARGE_OPTION;
Style3Path[THEME_ATTRIBUTE] = LIGHT_OPTION;
Style3Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style3Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style3Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;

const Style3Wrapper = {}
Style3Wrapper[STYLE_OBJECT] = {...Style3}
Style3Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
profileInitialsBadgeStyles.push(Style3Wrapper)
...
Style4[PROFILE_CONTAINER_SUBCOMPONENT].width = "40px"
Style4[PROFILE_CONTAINER_SUBCOMPONENT].height = "40px"
Style4[PROFILE_SUBCOMPONENT].fontSize = "16px"
Style4[PROFILE_SUBCOMPONENT].lineHeight = "20px"

const Style4Path = {}
Style4Path[SIZE_ATTRIBUTE] = MEDIUM_OPTION;
Style4Path[THEME_ATTRIBUTE] = LIGHT_OPTION;
Style4Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style4Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style4Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style4Wrapper = {}
Style4Wrapper[STYLE_OBJECT] = {...Style4}
Style4Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
profileInitialsBadgeStyles.push(Style4Wrapper)
...
Style5[PROFILE_CONTAINER_SUBCOMPONENT].width = "32px"
Style5[PROFILE_CONTAINER_SUBCOMPONENT].height = "32px"
...
Style5[PROFILE_SUBCOMPONENT].fontSize = "14px"
Style5[PROFILE_SUBCOMPONENT].lineHeight = "16px"

const Style5Path = {}
Style5Path[SIZE_ATTRIBUTE] = SMALL_OPTION;
Style5Path[THEME_ATTRIBUTE] = LIGHT_OPTION;
Style5Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style5Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style5Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style5Wrapper = {}
Style5Wrapper[STYLE_OBJECT] = {...Style5}
Style5Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style5Wrapper[PATH_STYLE] = Style5Path
profileInitialsBadgeStyles.push(Style5Wrapper)
...
Style6[PROFILE_CONTAINER_SUBCOMPONENT].width = "24px"
Style6[PROFILE_CONTAINER_SUBCOMPONENT].height = "24px"
Style6[PROFILE_SUBCOMPONENT].fontSize = "12px"
Style6[PROFILE_SUBCOMPONENT].lineHeight = "14px"
...
Style6Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style6Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style6Wrapper = {}
Style6Wrapper[STYLE_OBJECT] = {...Style6}
Style6Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style6Wrapper[PATH_STYLE] = Style6Path
profileInitialsBadgeStyles.push(Style6Wrapper)
...
Style7Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style7Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;

const Style7Wrapper = {}
Style7Wrapper[STYLE_OBJECT] = {...Style7}
Style7Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style7Wrapper[PATH_STYLE] = Style7Path
profileInitialsBadgeStyles.push(Style7Wrapper)
...
Style8[PROFILE_CONTAINER_SUBCOMPONENT].width = "56px"
Style8[PROFILE_CONTAINER_SUBCOMPONENT].height = "56px"
...
Style8Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style8Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style8Wrapper = {}
Style8Wrapper[STYLE_OBJECT] = {...Style8}
Style8Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style8Wrapper[PATH_STYLE] = Style8Path
profileInitialsBadgeStyles.push(Style8Wrapper)
...
Style9[PROFILE_CONTAINER_SUBCOMPONENT].width = "48px"
Style9[PROFILE_CONTAINER_SUBCOMPONENT].height = "48px"

const Style9Path = {}
Style9Path[SIZE_ATTRIBUTE] = LARGE_OPTION;
Style9Path[THEME_ATTRIBUTE] = DARK_OPTION;
Style9Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style9Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style9Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;

const Style9Wrapper = {}
Style9Wrapper[STYLE_OBJECT] = {...Style9}
Style9Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style9Wrapper[PATH_STYLE] = Style9Path
profileInitialsBadgeStyles.push(Style9Wrapper)
...
Style10[PROFILE_CONTAINER_SUBCOMPONENT].width = "40px"
Style10[PROFILE_CONTAINER_SUBCOMPONENT].height = "40px"
Style10[PROFILE_SUBCOMPONENT].fontSize = "16px"
Style10[PROFILE_SUBCOMPONENT].lineHeight = "20px"

const Style10Path = {}
Style10Path[SIZE_ATTRIBUTE] = MEDIUM_OPTION;
Style10Path[THEME_ATTRIBUTE] = DARK_OPTION;
Style10Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style10Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style10Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style10Wrapper = {}
Style10Wrapper[STYLE_OBJECT] = {...Style10}
Style10Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style10Wrapper[PATH_STYLE] = Style10Path
profileInitialsBadgeStyles.push(Style10Wrapper)
...
Style11[PROFILE_CONTAINER_SUBCOMPONENT].width = "32px"
Style11[PROFILE_CONTAINER_SUBCOMPONENT].height = "32px"
...
Style11[PROFILE_SUBCOMPONENT].fontSize = "14px"
Style11[PROFILE_SUBCOMPONENT].lineHeight = "16px"

const Style11Path = {}
Style11Path[SIZE_ATTRIBUTE] = SMALL_OPTION;
Style11Path[THEME_ATTRIBUTE] = DARK_OPTION;
Style11Path[STATE_ATTRIBUTE] = LOG_IN_OPTION;
Style11Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style11Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;

const Style11Wrapper = {}
Style11Wrapper[STYLE_OBJECT] = {...Style11}
Style11Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style11Wrapper[PATH_STYLE] = Style11Path
profileInitialsBadgeStyles.push(Style11Wrapper)
...
Style12[PROFILE_CONTAINER_SUBCOMPONENT].width = "24px"
Style12[PROFILE_CONTAINER_SUBCOMPONENT].height = "24px"
Style12[PROFILE_SUBCOMPONENT].fontSize = "12px"
Style12[PROFILE_SUBCOMPONENT].lineHeight = "14px"
...
Style12Path[SHOW_TITLE_OR_PICTURE_ATTRIBUTE] = SHOW_TITLE_OPTION;
Style12Path[SHOW_BADGE_ATTRIBUTE] = SHOW_BADGE_OPTION;
const Style12Wrapper = {}
Style12Wrapper[STYLE_OBJECT] = {...Style12}
Style12Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_BADGE_PROFILE_VARIANT
Style12Wrapper[PATH_STYLE] = Style12Path
profileInitialsBadgeStyles.push(Style12Wrapper)

export  {profileInitialsBadgeStyles};