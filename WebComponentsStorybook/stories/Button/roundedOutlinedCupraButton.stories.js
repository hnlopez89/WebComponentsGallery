...
control: { type: 'select' },
options: [ROUNDED_OUTLINED_OPTION],
}
...
var defaultArgs = {}
defaultArgs[HIERARCHY_ATTRIBUTE] = ROUNDED_OUTLINED_OPTION
...
export const RoundedOutlinedButton = Template.bind({});
RoundedOutlinedButton.args= {...defaultArgs}
