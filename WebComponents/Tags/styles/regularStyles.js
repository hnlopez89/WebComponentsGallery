...
import {CLOSE_ATTRIBUTE, COLOR_ATTRIBUTE, ICON_ATTRIBUTE, POSITION_ICON_ATTRIBUTE, COLOR_FONT_ATTRIBUTE} from "../constants.js"
...
import {RIGHT_ICON_POSITION_OPTION} from "../constants.js"
...
style2Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
style2Wrapper[PATH_STYLE] = Style2Path
regularTagsStyles.push(style2Wrapper)
...
Style3Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
regularTagsStyles.push(Style3Wrapper)
...
Style4Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
regularTagsStyles.push(Style4Wrapper)
...
Style5Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
Style5Wrapper[PATH_STYLE] = Style5Path
regularTagsStyles.push(Style5Wrapper)
...
Style6Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
Style6Wrapper[PATH_STYLE] = Style6Path
regularTagsStyles.push(Style6Wrapper)
...
Style7Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_VARIANT
Style7Wrapper[PATH_STYLE] = Style7Path
regularTagsStyles.push(Style7Wrapper)
