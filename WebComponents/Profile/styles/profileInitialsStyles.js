...
import {LOG_IN_OPTION, SHOW_TITLE_OPTION} from "../constants.js"
import {CONTAINER_SLOT_WRAPPER,
        INPUT_SLOT,
        CONTAINER_SUB_WRAPPER,
} from "../constants.js"
import { BRAND_ATLANTIC_10, TYPOGRAPHY_03} from "../../commonMethodsAndConstants/Styles/commonConstants.js"
...
style1Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
style1Wrapper[PATH_STYLE] = Style1Path
profileInitialsStyles.push(style1Wrapper)
...
Style2Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
Style2Wrapper[PATH_STYLE] = Style2Path
profileInitialsStyles.push(Style2Wrapper)
...
Style3Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
profileInitialsStyles.push(Style3Wrapper)
...
Style4[CONTAINER_SUB_WRAPPER].fontSize = "16px"
Style4[CONTAINER_SUB_WRAPPER].lineHeight = "20px"
...
Style4Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
profileInitialsStyles.push(Style4Wrapper)
...
Style5[CONTAINER_SUB_WRAPPER].fontSize = "14px"
Style5[CONTAINER_SUB_WRAPPER].lineHeight = "16px"
...
Style5Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
Style5Wrapper[PATH_STYLE] = Style5Path
profileInitialsStyles.push(Style5Wrapper)
...
Style6[CONTAINER_SUB_WRAPPER].fontSize = "12px"
Style6[CONTAINER_SUB_WRAPPER].lineHeight = "14px"
...
Style6Wrapper[COMPONENT_VARIANT_KEY] = LOG_IN_INITIALS_PROFILE_VARIANT
Style6Wrapper[PATH_STYLE] = Style6Path
profileInitialsStyles.push(Style6Wrapper)

const profileInitialsDarkStyles = []
profileInitialsStyles.forEach((style,index) => {
    profileInitialsDarkStyles.push(JSON.parse(JSON.stringify(style)))
    profileInitialsDarkStyles[index][PATH_STYLE][THEME_ATTRIBUTE] = DARK_OPTION
})
profileInitialsStyles.push(...profileInitialsDarkStyles)

export  {profileInitialsStyles};