...
import {TreeComponent, setStyleMethod, setKeysMethod, processStyleMethod,processIconStyleMethod ,destructureObject} from "../../commonMethodsAndConstants/Styles/commonMethods.js"
...
export const processIconStyle = processIconStyleMethod(EVENTS_OF_COMPONENT, DEFAULT_EVENT)
export const objectDestructuredEvent = destructureObject (EVENTS_OF_COMPONENT, DEFAULT_EVENT)