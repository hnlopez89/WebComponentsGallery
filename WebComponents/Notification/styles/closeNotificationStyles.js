...
import {REGULAR_CLOSE_NOTIFICATION_VARIANT} from "../constants.js"
...
import {CLOSE_ON_OPTION, ICON_OFF_OPTION} from "../constants.js"
...
style1Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_CLOSE_NOTIFICATION_VARIANT
style1Wrapper[PATH_STYLE] = Style1Path
closeNotificationStyles.push(style1Wrapper)

const Style2 = JSON.parse(JSON.stringify(Style1))
Style2[TITLES_ICONS_NOTIFICATION_CONTAINER].padding="16px 20px"
Style2[TITLES_ICONS_NOTIFICATION_CONTAINER].minHeight="56px"
...
Style2Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_CLOSE_NOTIFICATION_VARIANT
Style2Wrapper[PATH_STYLE] = Style2Path
closeNotificationStyles.push(Style2Wrapper)
...
Style3Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_CLOSE_NOTIFICATION_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
closeNotificationStyles.push(Style3Wrapper)
...
Style4Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_CLOSE_NOTIFICATION_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
closeNotificationStyles.push(Style4Wrapper)


const closeNotificationDarkStyles = []
closeNotificationStyles.forEach((style,index) => {
    closeNotificationDarkStyles.push(JSON.parse(JSON.stringify(style)))
    closeNotificationDarkStyles[index][STYLE_OBJECT][PATH_SUBCOMPONENT][SVG_ATTRIBUTES].fill = BACKGROUND_01
    closeNotificationDarkStyles[index][STYLE_OBJECT][TITLES_ICONS_NOTIFICATION_CONTAINER].backgroundColor = BACKGROUND_02
    closeNotificationDarkStyles[index][STYLE_OBJECT][TITLES_NOTIFICATION_CONTAINER].color = TYPOGRAPHY_01
    closeNotificationDarkStyles[index][STYLE_OBJECT][LINK_SUBTITLE].color = TYPOGRAPHY_01    
    closeNotificationDarkStyles[index][STYLE_OBJECT][LINK_TITLE].color = TYPOGRAPHY_01    
    closeNotificationDarkStyles[index][PATH_STYLE][COLOR_ATTRIBUTE] = BLACK_OPTION
})
closeNotificationStyles.push(...closeNotificationDarkStyles)



const closeNotificationSuccessStyles = []
closeNotificationStyles.forEach((style,index) => {
    closeNotificationSuccessStyles.push(JSON.parse(JSON.stringify(style)))
    closeNotificationSuccessStyles[index][STYLE_OBJECT][CONTAINER_WRAPPER].backgroundColor = ALERT_SUCCESS
    closeNotificationSuccessStyles[index][PATH_STYLE][STATE_ATTRIBUTE] = SUCCESS_OPTION
})
const closeNotificationErrorStyles = []
closeNotificationStyles.forEach((style,index) => {
    closeNotificationErrorStyles.push(JSON.parse(JSON.stringify(style)))
    if(closeNotificationErrorStyles[index][PATH_STYLE][COLOR_ATTRIBUTE] === WHITE_OPTION){
        closeNotificationErrorStyles[index][STYLE_OBJECT][CONTAINER_WRAPPER].backgroundColor = DANGER_LIGHT_THEME
    } else {
        closeNotificationErrorStyles[index][STYLE_OBJECT][CONTAINER_WRAPPER].backgroundColor = DANGER_DARK_THEME
        closeNotificationErrorStyles[index][PATH_STYLE][COLOR_ATTRIBUTE] = BLACK_OPTION
    }
    closeNotificationErrorStyles[index][PATH_STYLE][STATE_ATTRIBUTE] = ERROR_OPTION
})
const closeNotificationWarningStyles = []
closeNotificationStyles.forEach((style,index) => {
    closeNotificationWarningStyles.push(JSON.parse(JSON.stringify(style)))
    closeNotificationWarningStyles[index][STYLE_OBJECT][CONTAINER_WRAPPER].backgroundColor = ALERT_WARNING
    closeNotificationWarningStyles[index][PATH_STYLE][STATE_ATTRIBUTE] = WARNING_OPTION
})
closeNotificationStyles.push(...closeNotificationErrorStyles)
closeNotificationStyles.push(...closeNotificationWarningStyles)
closeNotificationStyles.push(...closeNotificationSuccessStyles)


export  {closeNotificationStyles};