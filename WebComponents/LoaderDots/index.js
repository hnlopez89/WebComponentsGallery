...
function constructionLoaderDots() 
{
    this.dataAttributes = {}
...
class ComponentLoaderDots extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        const loader = constructionLoaderDots.bind(this)
...
if (customElements.get(CUSTOM_ELEMENT_NAME) === undefined) customElements.define(CUSTOM_ELEMENT_NAME, class extends ComponentLoaderDots { });
export const COMPONENT_LOADERDOTS = CUSTOM_ELEMENT_NAME;