...
const constructionTextarea = function ()  {
...
class ComponentTA extends HTMLElement {
    constructor()
    {
        super();
    ...
    connectedCallback() {
        ...
        const construction = constructionTextarea.bind(this)
        if (!this.built)
        {
...
if (customElements.get(NAME_OF_COMPONENT) === undefined) customElements.define(NAME_OF_COMPONENT, class extends ComponentTA {});
export const COMPONENT_TEXT_AREA = NAME_OF_COMPONENT;
