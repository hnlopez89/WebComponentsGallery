...
import {FULLSCREEN_VARIANT} from "../constants.js"
import {MODE_ATTRIBUTE} from "../constants.js"
import {FULLSCREEN_OPTION} from "../constants.js"
...
import {PATH_STYLE,STYLE_OBJECT,COMPONENT_VARIANT_KEY, TYPOGRAPHY_03, BLACK} from "../../commonMethodsAndConstants/Styles/commonConstants.js"
...
const Style1Path = {}
Style1Path[MODE_ATTRIBUTE] = FULLSCREEN_OPTION

const styleWrapper1 = {}
styleWrapper1[STYLE_OBJECT] = {...Style1}
styleWrapper1[COMPONENT_VARIANT_KEY] = FULLSCREEN_VARIANT
styleWrapper1[PATH_STYLE] = Style1Path
fullscreenModalStyles.push(styleWrapper1)



export {fullscreenModalStyles}