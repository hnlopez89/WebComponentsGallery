...
connectedCallback() {
    ...
    if(state !== INACTIVE_OPTION){
        document.addEventListener('click', function(event) {
            ...
            {
                if (thisComponent.getAttribute(FORM_VALUE_ATTRIBUTE)=="" && thisComponent.getAttribute(STATE_ATTRIBUTE)!== INITIAL_OPTION) thisComponent.setAttribute(STATE_ATTRIBUTE,INITIAL_OPTION)
                else 
                {
...
export const regularTextAreaDescriptorComponent = function (attributes,parentElement)
{
