...
import {HIERARCHY_ATTRIBUTE, 
    ...
    ICON_ATTRIBUTE,
    WIDTH_ATTRIBUTE,
    FOCUS_BUTTON_EVENT} from "../constants.js"
...
import {PATH_STYLE,
    ...
    PRIMARY_BUTTON_LIGHT_ACTIVE} from "../../commonMethodsAndConstants/Styles/commonConstants.js"
...
Style1 [BUTTON_SUBCOMPONENT][FOCUS_BUTTON_EVENT] = {
    ...
    border: `2px solid ${VALIDATED_COLOR}`,
    }
...
...SIZE_STYLES[LARGE_OPTION][REGULAR_BUTTON_VARIANT][BUTTON_SUBCOMPONENT],
padding: "12px 15px 14px",
border: `1px solid ${PRIMARY_BUTTON_LIGHT_ACTIVE}`,
...
boxShadow: "none",
padding: "11px 14px 13px",
border: `2px solid ${PRIMARY_BUTTON_LIGHT_ACTIVE}`,
}
