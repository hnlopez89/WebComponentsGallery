...
import {CLOSE_ATTRIBUTE, COLOR_ATTRIBUTE, ICON_ATTRIBUTE, POSITION_ICON_ATTRIBUTE, LEFT_ICON_POSITION_OPTION} from "../constants.js"
...
Style1Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;
...
Style2Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;


const style2Wrapper = {}
style2Wrapper[STYLE_OBJECT] = {...Style2}
style2Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
style2Wrapper[PATH_STYLE] = Style2Path
regularTagsIconLeftStyles.push(style2Wrapper)
...
Style3Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;

const Style3Wrapper = {}
Style3Wrapper[STYLE_OBJECT] = {...Style3}
Style3Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
regularTagsIconLeftStyles.push(Style3Wrapper)
...
Style4Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;

const Style4Wrapper = {}
Style4Wrapper[STYLE_OBJECT] = {...Style4}
Style4Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
regularTagsIconLeftStyles.push(Style4Wrapper)
...
Style5Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;

const Style5Wrapper = {}
Style5Wrapper[STYLE_OBJECT] = {...Style5}
Style5Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
Style5Wrapper[PATH_STYLE] = Style5Path
regularTagsIconLeftStyles.push(Style5Wrapper)
...
Style6Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;

const Style6Wrapper = {}
Style6Wrapper[STYLE_OBJECT] = {...Style6}
Style6Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
Style6Wrapper[PATH_STYLE] = Style6Path
regularTagsIconLeftStyles.push(Style6Wrapper)
...
Style7Path[POSITION_ICON_ATTRIBUTE] = LEFT_ICON_POSITION_OPTION;

const Style7Wrapper = {}
Style7Wrapper[STYLE_OBJECT] = {...Style7}
Style7Wrapper[COMPONENT_VARIANT_KEY] = REGULAR_TAGS_ICON_LEFT_VARIANT
Style7Wrapper[PATH_STYLE] = Style7Path
regularTagsIconLeftStyles.push(Style7Wrapper)
