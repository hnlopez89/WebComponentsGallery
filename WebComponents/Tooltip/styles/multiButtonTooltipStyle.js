...
import { MULTI_BUTTON_OPTION} from "../constants.js";
...
import { MULTI_BUTTON_TOOLTIP_VARIANT } from "../constants.js";
import { WRAPPER_COMPONENT, ICON_COMPONENT, CONTENT_COMPONENT, CONTENT_WRAPPER,
        SVG_SUBCOMPONENT, PATH_SUBCOMPONENT, SUBTITLE_COMPONENT, TITLE_COMPONENT,
        CONTAINER_BUTTON_WRAPPER,BUTTON_CONFIRMATION,BUTTON_CANCELATION } from "../constants.js";
...
const multiButtonTooltipStyles = []
const Style1 = {}
...
Style1[BUTTON_CANCELATION]= {
    display: "block",
    backgroundColor: BACKGROUND_01,
    color: TYPOGRAPHY_03,
    width: "100%",
    cursor: "pointer",
    borderColor: BACKGROUND_02,
    padding: "7px 16px 9px",
    fontSize: "14px",
    lineHight: "16px",
    fontFamily: "Roboto, Sans-Serif",
...
Style1Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style1Wrapper = {}
Style1Wrapper[STYLE_OBJECT] = {...Style1}
Style1Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style1Wrapper[PATH_STYLE] = Style1Path
multiButtonTooltipStyles.push(Style1Wrapper)
...
Style2Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style2Wrapper = {}
Style2Wrapper[STYLE_OBJECT] = {...Style2}
Style2Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style2Wrapper[PATH_STYLE] = Style2Path
multiButtonTooltipStyles.push(Style2Wrapper)
...
Style3Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;
const Style3Wrapper = {}
Style3Wrapper[STYLE_OBJECT] = {...Style3}
Style3Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style3Wrapper[PATH_STYLE] = Style3Path
multiButtonTooltipStyles.push(Style3Wrapper)
...
Style4Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style4Wrapper = {}
Style4Wrapper[STYLE_OBJECT] = {...Style4}
Style4Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style4Wrapper[PATH_STYLE] = Style4Path
multiButtonTooltipStyles.push(Style4Wrapper)
...
Style5Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;
const Style5Wrapper = {}
Style5Wrapper[STYLE_OBJECT] = {...Style5}
Style5Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style5Wrapper[PATH_STYLE] = Style5Path
multiButtonTooltipStyles.push(Style5Wrapper)
...
Style6Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style6Wrapper = {}
Style6Wrapper[STYLE_OBJECT] = {...Style6}
Style6Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style6Wrapper[PATH_STYLE] = Style6Path
multiButtonTooltipStyles.push(Style6Wrapper)
...
Style7Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style7Wrapper = {}
Style7Wrapper[STYLE_OBJECT] = {...Style7}
Style7Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style7Wrapper[PATH_STYLE] = Style7Path
multiButtonTooltipStyles.push(Style7Wrapper)
...
Style8Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style8Wrapper = {}
Style8Wrapper[STYLE_OBJECT] = {...Style8}
Style8Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style8Wrapper[PATH_STYLE] = Style8Path
multiButtonTooltipStyles.push(Style8Wrapper)
...
Style9Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style9Wrapper = {}
Style9Wrapper[STYLE_OBJECT] = {...Style9}
Style9Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style9Wrapper[PATH_STYLE] = Style9Path
multiButtonTooltipStyles.push(Style9Wrapper)
...
Style10Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;

const Style10Wrapper = {}
Style10Wrapper[STYLE_OBJECT] = {...Style10}
Style10Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style10Wrapper[PATH_STYLE] = Style10Path
multiButtonTooltipStyles.push(Style10Wrapper)
...
Style11Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;
const Style11Wrapper = {}
Style11Wrapper[STYLE_OBJECT] = {...Style11}
Style11Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style11Wrapper[PATH_STYLE] = Style11Path
multiButtonTooltipStyles.push(Style11Wrapper)
...
Style12Path[BUTTON_NUMBER_ATTRIBUTE] = MULTI_BUTTON_OPTION;
const Style12Wrapper = {}
Style12Wrapper[STYLE_OBJECT] = {...Style12}
Style12Wrapper[COMPONENT_VARIANT_KEY] = MULTI_BUTTON_TOOLTIP_VARIANT
Style12Wrapper[PATH_STYLE] = Style12Path
multiButtonTooltipStyles.push(Style12Wrapper)

const multiButtonTooltipDarkStyles = []
multiButtonTooltipStyles.forEach((style, index)=> {
    multiButtonTooltipDarkStyles.push(JSON.parse(JSON.stringify(style)))
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][TITLE_COMPONENT].color = TYPOGRAPHY_03
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][SUBTITLE_COMPONENT].color = TYPOGRAPHY_04
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][CONTENT_WRAPPER].backgroundColor = BACKGROUND_01
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][CONTENT_COMPONENT].backgroundColor = BACKGROUND_01
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CONFIRMATION].backgroundColor = BACKGROUND_01
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CONFIRMATION].borderColor = TYPOGRAPHY_03
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CONFIRMATION].color = TYPOGRAPHY_03
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CANCELATION].backgroundColor = TYPOGRAPHY_03
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CANCELATION].borderColor = BACKGROUND_01
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][BUTTON_CANCELATION].color = TYPOGRAPHY_01
    multiButtonTooltipDarkStyles[index][STYLE_OBJECT][PATH_SUBCOMPONENT][SVG_ATTRIBUTES].fill = BACKGROUND_01
    multiButtonTooltipDarkStyles[index][PATH_STYLE][COLOR_ATTRIBUTE] = LIGHT_OPTION
    
})

multiButtonTooltipStyles.push(...multiButtonTooltipDarkStyles)

export  {multiButtonTooltipStyles};